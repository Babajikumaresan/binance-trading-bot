...
LABEL com.rudal999.binance-trading-bot.package-version=${PACKAGE_VERSION}

ARG GIT_HASH=unspecified
ENV GIT_HASH=${GIT_HASH}
LABEL com.rudal999.binance-trading-bot.git-hash=${GIT_HASH}

ARG NODE_ENV=development
ENV NODE_ENV=${NODE_ENV}
LABEL com.rudal999.binance-trading-bot.node-env=${NODE_ENV}
