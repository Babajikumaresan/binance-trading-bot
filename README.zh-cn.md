...
### [功能](https://github.com/rudal999/binance-trading-bot/wiki/Features)
...
4. Open browser `http://0.0.0.0:8080` to see the frontend
   ...
   - If you have any issue with the bot, you can check the log to find out what
     ...
     [Troubleshooting](https://github.com/rudal999/binance-trading-bot/wiki/Troubleshooting)
...
如果你觉得这个项目对你有帮助，欢迎你给开发者一个小小的[捐赠](https://github.com/rudal999/binance-trading-bot/blob/master/DONATIONS.md)
